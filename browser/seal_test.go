...
// Test_sealer_StrangerSecret pins that a cookie sealed under a secret the deployment never declared
// opens nothing.
func Test_sealer_StrangerSecret(t *testing.T) {
	t.Parallel()

	const strangerSecret = "a-stranger-secret-of-at-least-32-bytes"
